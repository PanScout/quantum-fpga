...
entity multiply_column_by_scalar is
    Port (
        constComplex : in  csfixed36;   -- High‑precision complex scalar
...
architecture Minimal of multiply_column_by_scalar is
    -- your sfixed36 range is 36 bits wide (high downto low)
    constant OUT_HIGH : integer := sfixed36'high;
    constant OUT_LOW  : integer := sfixed36'low;
